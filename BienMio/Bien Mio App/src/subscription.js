...
const convertedVapidKey = urlBase64ToUint8Array(process.env.REACT_APP_WEB_PUSH_PUBLIC_KEY)
...
function sendSubscription(subscription, token) {
  return fetch(`${config.baseAPIUrl}/notifications/subscribe`, {
    method: 'POST',
    body: JSON.stringify({
