...
{
    [Table("publicacion_aplicarpago", Schema = "public")]
    public class Publicacion_Aplicarpago
    {
        [Key]
        public int id_publicacionpago { get; set; }
        ...
        public Publicacion_Gasto ObjGasto { get; set; }
