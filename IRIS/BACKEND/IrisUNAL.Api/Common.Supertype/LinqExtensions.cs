...
namespace IrisUNAL.Api.Common.Supertype
{
    ...
    {
        public static List<Dictionary<string, object>> DataTableToListDictionary(this System.Data.DataTable table)
        {
    ...
    {
        public static void DeleteWhere2<T>(this DbContext db, Expression<Func<T, bool>> filter) where T : class
        {
