    ...
    for (var k = 0; k < inputText.length; k++) {
        ...
        if (idSpan != '') {
            ...
            if (spanRequired != undefined) {
                //VALIDAR QUE NO TENGA PALABRAS RESTRINGIDAS                
                /*
                if ((fieldValue.indexOf('delete ') > -1) || (fieldValue.indexOf('drop ') > -1) || (fieldValue.indexOf('select ') > -1) || (fieldValue.indexOf('alter ') > -1)) {
...
function validateTextXSSLastButtonByForm(formulario) {
    ...
    for (var k = 0; k < inputText.length; k++) {
        ...
        if (idSpan != '') {
            ...
            if (spanRequired != undefined) {
                //VALIDAR QUE NO TENGA PALABRAS RESTRINGIDAS                
                if ((fieldValue.indexOf('delete ') > -1) || (fieldValue.indexOf('drop') > -1) || (fieldValue.indexOf('select ') > -1) || (fieldValue.indexOf('alter ') > -1) || (fieldValue.indexOf('truncate ') > -1)) {
                    $(inputText[k]).addClass('is-invalid_form');
                    $(inputText[k]).removeClass('is-valid_form');
                    $("#" + spanRequired).removeClass('ocultar');
                    checkValidityXSS = false;
