        ...
        "columns": [
                ...
                { "data": "valor" },
                {
                    "render": function (data, type, row, meta) {
                        return '<img src="../images/iris/Editar.png" class="cambiarMouse" title="Editar Datos" onclick="EditarProyectoInvestigacionResoluciones(' + row.id_proyectoresolucion + ')" data-bs-toggle="modal" data-bs-target="#ModalCicloFinancieroConvenios" /> ' +
