function Publicaciones_DivulgacionHerramientaRedSocial() {
    ...
    this.CamposHTML = [
        [
            ...
            {campo: 'nombre', tipo: 'string', nullable: false, llave: '', etiqueta: 'Red Social', placeholder: 'Red Social', title: '', numcols: 3, maxlength: 100, funconchange: null, funconclick: null},
            {campo: 'enlace', tipo: 'string', nullable: false, llave: '', etiqueta: 'Link Publicación', placeholder: 'Link Publicación', title: '', numcols: 5, maxlength: 100, funconchange: null, funconclick: null},
    ...
    this.Nombre = 'Publicaciones_DivulgacionHerramientaRedSocial';
    ...
    this.ParamGetName3 = '';
    this.ObjDatos = null;
    this.FormEdicion = 'formPublicaciones_DivulgacionHerramientasRedSocial';
    this.IsModal = true;
