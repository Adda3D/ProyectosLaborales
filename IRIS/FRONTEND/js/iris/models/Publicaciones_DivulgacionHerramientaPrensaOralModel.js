function Publicaciones_DivulgacionHerramientaPrensaOral() {
    ...
    this.Nombre = 'Publicaciones_DivulgacionHerramientaPrensaOral';
    ...
    this.ParamGetName3 = '';
    this.ObjDatos = null;
    this.FormEdicion = 'formPublicaciones_DivulgacionHerramientasPrensaOral';
    this.IsModal = true;
