function Publicacion_DetalleAportes() {
    this.Campos = [
    ...
    this.Nombre = 'Publicacion_DetalleAportes';
    this.ControllerName = 'Publicaciones_CrearPublicacion';
    this.MethodGet = 'GetPublicaciones_CrearPublicacionAportes';
    this.MethodUpdate = 'UpdatePublicaciones_CrearPublicacionAportes';
    this.MethodInsert = '';
    ...
    this.ObjDatos = null;
    this.FormEdicion = 'formPublicacionDetalleAportes';
    this.IsModal = false;
