function Publicaciones_DivulgacionHerramientaPrensaAudioVisual() {
    ...
    this.Nombre = 'Publicaciones_DivulgacionHerramientaPrensaAudioVisual';
    ...
    this.ParamGetName3 = '';
    this.ObjDatos = null;
    this.FormEdicion = 'formPublicaciones_DivulgacionHerramientasPrensaAudioVisual';
    this.IsModal = true;
